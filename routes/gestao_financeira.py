...
@gestao_financeira_bp.route('/relatorio-fumcad')
@login_required
@requires_access('gestao_financeira')
def relatorio_fumcad():
    """Página de Resultados FUMCAD"""
    return render_template('gestao_financeira/relatorio_fumcad.html')


@gestao_financeira_bp.route('/api/fumcad/disponibilidade')
@login_required
@requires_access('gestao_financeira')
